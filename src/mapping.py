...
mapping_services_suggestions_2025 = {
    "A1: information available online?": "Rendere le informazioni sul servizio disponibili online",
    "A2: service available online?": "Rendere il servizio effettivo disponibile online",
    "A3: available through portal?": "Garantire che il servizio/le informazioni sul servizio siano disponibili tramite i portali rilevanti",
    "D1: expectations duration process?": "Chiarire esplicitamente la durata prevista del processo",
    "D2: delivery timelines clear?": "Rendere chiari e facilmente accessibili i tempi previsti per l'erogazione",
    "D3: maximum time limit delivery?": "Definire e comunicare chiaramente il limite massimo di tempo per l'erogazione del servizio",
    "E1: authentication required?": "Esplicitare chiaramente se è necessaria l'autenticazione per accedere al servizio",
    "E2: online authentication possible?": "Consentire l'autenticazione online per accedere al servizio",
    "E3: can you use national eID?": "Permettere l'uso dell'identità digitale nazionale per l'autenticazione",
    "E4: access another service without re-auth?": "Consentire l'accesso ad altri servizi correlati senza dover effettuare nuovamente l'autenticazione",
    "E5: can decide using private eID?": "Permettere agli utenti di utilizzare un'identità digitale privata per l'autenticazione",
    "G8: personal info required?": "Chiarire esplicitamente quali informazioni personali sono richieste agli utenti",
    "G9: personal data pre-filled?": "Consentire il precompilamento automatico dei dati personali già disponibili",
    "K1: Automatic acknowledgement of receipt?": "Fornire una conferma automatica di ricezione delle richieste inviate dagli utenti",
    "K2: Electronic output of service?": "Rendere disponibile l'output del servizio in formato elettronico",
    "K3: Is there a notification of completion?": "Fornire una notifica automatica al completamento del servizio",
    "Mobile Friendliness": "Garantire che il servizio sia ottimizzato per l'accesso da dispositivi mobili",
    "Barrier national eID required": "Rimuovere la barriera della necessità di identificazione/autenticazione online nazionale",
    "Barrier eDoc required": "Consentire la presentazione dei documenti elettronici richiesti dai cittadini stranieri",
    "Barrier translation/recognition documents?": "Eliminare la necessità di traduzione o riconoscimento dei documenti richiesti",
    "information available foreigner?": "Rendere le informazioni disponibili anche per gli utenti stranieri",
    "service available foreigner?": "Consentire agli utenti stranieri di accedere al servizio online",
    "Barrier language issues": "Fornire traduzioni chiare o un'interfaccia multilingue per superare le barriere linguistiche",
    "The translation provided on the website is unclear or incorrect": "Migliorare la qualità delle traduzioni fornite sul sito web",
    "Barrier lack of information": "Fornire informazioni complete e facilmente accessibili anche per utenti internazionali",
    "Barrier need to meet face to face? ": "Eliminare la necessità di incontri fisici per completare il servizio",
    "Other barriers (explain)": "Identificare e affrontare ulteriori barriere specifiche per gli utenti",
    "Authentification to access?": "Chiarire se è necessaria un'autenticazione per accedere al servizio",
    "Authentificate using national eID?": "Permettere l'autenticazione tramite eID nazionale anche per utenti transfrontalieri",
    "Cross-border Documentation required?": "Specificare se sono richiesti documenti per utenti transfrontalieri",
    "OOTS implemented?": "Indicare se è stato implementato il sistema Once-Only (OOTS) per lo scambio di dati tra paesi",
    "Payment required?": "Chiarire se è previsto un pagamento per accedere al servizio",
    "Cross-border ePayment available?": "Consentire il pagamento elettronico anche da altri paesi",
    "Automatic acknowledgement of receipt?": "Fornire una conferma automatica di ricezione della richiesta",
    "Electronic output of service?": "Fornire un output elettronico del servizio",
    "Is there a notification of completion?": "Comunicare automaticamente all'utente il completamento del servizio",
    "This column shows whether a service is a SDGR service": "Indicare se il servizio rientra nel campo di applicazione della SDGR",
    "This column shows whether a service could potentially have OOTS implemented": "Indicare se il servizio è potenzialmente idoneo all'implementazione del principio Once-Only (OOTS)"
}
